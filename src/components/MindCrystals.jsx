...
const CRYSTALS = [
  ...
  },
  {
    ...
    icon:"🎯",
    effect:"Crit rate +15%",
    ascended:"Crit rate +25%",
    tier:"B",
    desc:"Flat crit rate increase. Stronger on characters with existing crit scaling in their potentials. Weaker on characters that don't have crit synergies built in.",
    builds:["Crit Build","Naoto Build"],
    chars:["naoto","hibiki","bullet"],
  },
  {
    id:"fatal-blow",
    name:"Fatal Blow",
    ...
    icon:"💀",
    effect:"Crit DMG +50%",
    ascended:"Crit DMG +75%",
    tier:"A",
    desc:"Multiplies critical hit damage. Pairs with Focus for a full crit build. Naoto's kit synergizes natively with crit stacking — this is a core pick for him.",
    builds:["Crit Build","Naoto Build"],
    chars:["naoto","hibiki"],
  },
  {
    ...
    color:"#C9A227",
    icon:"🔊",
    effect:"Tactic DMG +25%",
    ascended:"Tactic DMG +40%",
    tier:"A",
    desc:"Direct tactic damage amplifier. Best in pure tactic-focused builds with Cold Attack, Shadow Spike, or Light Spear as primary damage sources. Stacks multiplicatively with element bonuses.",
    builds:["Tactic Build","Summon Build","Zoning"],
    chars:["rachel","kokonoe","lambda","hazama"],
  },
  ...
  },
  {
    ...
    color:"#4ADE80",
    icon:"🔰",
    effect:"Absorb 100 DMG per hit (recharges)",
    ascended:"Absorb 150 DMG per hit (recharges)",
    tier:"A",
    desc:"Effective against rapid multi-hit attacks. Recharging shield means continuous mitigation throughout the run. Especially strong vs. bosses with projectile spam.",
    builds:["Tank Build","High Entropy"],
    chars:["hakumen","bullet","naoto"],
  },
  {
    id:"adrenaline",
    name:"Adrenaline",
    ...
    color:"#4ADE80",
    icon:"⚡",
    effect:"Move speed +20% when HP < 50%",
    ascended:"Move speed +30% when HP < 50%",
    tier:"B",
    desc:"Panic speed boost below half health. Can save runs when combined with 'Not Dead Yet' — survive the cheat death then move faster to reset position.",
    builds:["Aggressive","Mobility"],
    chars:["taokaka","hibiki","mai"],
  },
  {
    id:"iron-will",
    name:"Iron Will",
    ...
    color:"#4ADE80",
    icon:"🏋",
    effect:"Gain super armor when HP < 30%",
    ascended:"Gain super armor when HP < 40%",
    tier:"B",
    desc:"Prevents stagger at critical HP. Can turn potential deaths into survivable windows. Best on aggressive characters with high damage output who can reverse a situation quickly.",
    builds:["Tank Build","Aggressive"],
    chars:["ragna","hakumen","bullet"],
  },
  ...
  // ── ADVANCED / NICHE ──
  {
    ...
    color:"#A78BFA",
    icon:"👻",
    effect:"Dash grants brief invincibility",
    ascended:"Dash invincibility frames increased",
    tier:"A",
    desc:"Converts dashes into dodge windows. Massively rewards mobile players. With proper timing, can dodge almost every telegraphed attack in the game.",
    builds:["Mobility Build","Dodge Build"],
    chars:["hibiki","taokaka","mai","noel","icey"],
  },
  {
    id:"combo-extender",
    name:"Combo Extender",
    ...
    color:"#A78BFA",
    icon:"🔗",
    effect:"Combo timer +40%",
    ascended:"Combo timer +60%",
    tier:"B",
    desc:"Extended combo windows before the counter resets. Critical for Exhilaration/Combo Surge builds where maintaining high combos is everything.",
    builds:["Combo Build","Exhilaration Build"],
    chars:["taokaka","noel","hibiki","mai"],
  },
  {
    id:"legacy-amplifier",
    ...
    color:"#A78BFA",
    icon:"📡",
    effect:"Legacy Skill DMG +35%",
    ascended:"Legacy Skill DMG +50%",
    tier:"A",
    desc:"Boosts inherited Legacy Skill damage. Transforms already-strong legacies into run-defining tools. Best with Jin ice sword legacy or Hakumen counter legacy.",
    builds:["Legacy Build","Hybrid"],
    chars:["jin","hakumen","es","lambda"],
  },
  {
    id:"summon-booster",
    name:"Summon Booster",
    ...
    color:"#A78BFA",
    icon:"🐉",
    effect:"Summon Tactic DMG +30%",
    ascended:"Summon Tactic DMG +45%",
    tier:"A",
    desc:"Direct summon damage amplifier. Strongest in Kokonoe missile builds or Hibiki shadow clone setups. Stacks with Resonance for full tactic/summon builds.",
    builds:["Summon Build","Kokonoe Build","Hibiki Clone"],
    chars:["kokonoe","hibiki","rachel","lambda"],
  },
  {
    id:"overcharge",
    name:"Overcharge",
    ...
    color:"#A78BFA",
    icon:"⚡",
    effect:"SP gain rate +25%",
    ascended:"SP gain rate +40%",
    tier:"B",
    desc:"Generates SP faster for skill use. Enables more frequent skill rotations. Excellent on Noel (Drive-heavy) and Ragna (BloodScythe spam).",
    builds:["Skill Build","SP Build"],
    chars:["noel","ragna","hakumen","icey"],
  },
  {
    id:"hunters-mark",
    name:"Hunter's Mark",
    ...
    color:"#A78BFA",
    icon:"🎯",
    effect:"Marked enemy takes +20% DMG from all sources",
    ascended:"Marked enemy takes +30% DMG from all sources",
    tier:"A",
    desc:"Party-wide damage amplifier on priority targets. Applies to ALL damage sources — attack, skill, tactic, summon, legacy. Best used on Elites and bosses.",
    builds:["All Damage","High Entropy","Boss Kill"],
    chars:["naoto","hibiki","lambda","prisoner"],
  },
  {
    id:"blood-pact",
    name:"Blood Pact",
    ...
    color:"#A78BFA",
    icon:"🩸",
    effect:"HP cost abilities gain +20% DMG",
    ascended:"HP cost abilities gain +35% DMG",
    tier:"B",
    desc:"Specifically buffs abilities that consume HP as cost. Best on Ragna (Blood Scythe) and Naoto (Blood Edge attacks). Situational but high-ceiling for those characters.",
    builds:["Ragna Build","Naoto Build"],
    chars:["ragna","naoto"],
  },
  {
    id:"apex-predator",
    ...
    color:"#A78BFA",
    icon:"👑",
    effect:"At full HP, all DMG +25%",
    ascended:"At full HP, all DMG +35%",
    tier:"B",
    desc:"High-ceiling if you can maintain full HP. Combines with Second Wind for constant activation between stages. Punishes chip damage — pairs best with Defensive Combo.",
    builds:["Aggressive","Perfect Play"],
    chars:["hakumen","jin","rachel"],
  },
  {
    id:"chain-reaction",
    name:"Chain Reaction",
    ...
    color:"#A78BFA",
    icon:"⛓",
    effect:"Killing an enemy grants +10% DMG for 8s (stack×3)",
    ascended:"Killing an enemy grants +12% DMG for 10s (stack×3)",
    tier:"A",
    desc:"Snowballs through waves of enemies. Excellent in stage clears where you can chain kills rapidly. Falls off on bosses unless combined with fast elite kills first.",
    builds:["Wave Clear","Aggressive"],
    chars:["taokaka","noel","hibiki","icey","prisoner"],
  },
];
